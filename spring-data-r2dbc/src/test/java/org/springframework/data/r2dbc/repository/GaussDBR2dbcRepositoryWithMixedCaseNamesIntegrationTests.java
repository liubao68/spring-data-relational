 ...
 * characters against GaussDB.
 *
 * Notes: this file is token from PostgresR2dbcRepositoryWithMixedCaseNamesIntegrationTests and add specific changes for GaussDB
 *
 * @author liubao
 */
@ExtendWith(SpringExtension.class)
@ContextConfiguration
public class GaussDBR2dbcRepositoryWithMixedCaseNamesIntegrationTests
	...
	static class IntegrationTestConfiguration extends AbstractR2dbcConfiguration {
		...
		public ConnectionFactory connectionFactory() {
			return GaussDBTestSupport.createConnectionFactory(database);
		}
	...
	protected DataSource createDataSource() {
		return GaussDBTestSupport.createDataSource(database);
	}
	...
	protected String getCreateTableStatement() {
		return GaussDBTestSupport.CREATE_TABLE_LEGOSET_WITH_MIXED_CASE_NAMES;
	}

	@Override
	protected String getDropTableStatement() {
		return GaussDBTestSupport.DROP_TABLE_LEGOSET_WITH_MIXED_CASE_NAMES;
	}
}
