...
/**
 * Integration tests for {@link LegoSetRepository} using {@link R2dbcRepositoryFactory} against GaussDB.
 *
 * Notes: this file is token from PostgresR2dbcRepositoryIntegrationTests and add specific changes for GaussDB
 *
 * @author liubao
 */
@ExtendWith(SpringExtension.class)
@ContextConfiguration
public class GaussDBR2dbcRepositoryIntegrationTests extends AbstractR2dbcRepositoryIntegrationTests {
	...
	@EnableR2dbcRepositories(considerNestedRepositories = true,
			includeFilters = @Filter(
					classes = { GaussDBLegoSetRepository.class, WithJsonRepository.class, WithHStoreRepository.class },
	...
	protected String getCreateTableStatement() {
		return GaussDBTestSupport.CREATE_TABLE_LEGOSET + ";CREATE SEQUENCE IF NOT EXISTS person_seq;";
	}

	@Override
	protected Class<? extends LegoSetRepository> getRepositoryInterfaceType() {
		return GaussDBLegoSetRepository.class;
	}

	interface GaussDBLegoSetRepository extends LegoSetRepository {
